 ...
 * Descripción General:
 *
 * Este archivo contiene la implementación de una clase MinHeap, que es un 
 * monticulo mínimo. Esta estructura de datos permite almacenar elementos de
 * un valor numerico y mantener la propiedad de monticulo, donde el elemento
 * que se encuentra en la raíz es el menor de todos los elementos.
 *
